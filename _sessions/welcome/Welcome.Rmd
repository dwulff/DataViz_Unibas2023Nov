...
author: "Visualizing and communicating data with R<br>
  <a href='https://therbootcamp.github.io'>
    <font style='font-size:1em'>The R Bootcamp @ Unibas</font>
  </a>
  <br>
  <a href='https://therbootcamp.github.io/DataViz_Unibas2023Nov/'>
...
>### The goal of this workshop is to introduce you to principles of data visualization and communication and how to realize them with R's data visualization tools!
...
<ul>
  ...
  <ul class="level">
    <li><span>30 introduction</high></span></li> 
    <li><span>30 coding exercises</span></li> 
    <li><span>short Q&A</span></li> 
  </ul>
  <li class="m2"><span><high>30 min consulting session</high> after conclusion of the course.</span></li>
</ul>
...
.pull-right45[
<br><br><br>
<img src="image/schedule.png" align="center" style="padding-top:16px" height=490>
...
<table class="tg"  style="cellspacing:0; cellpadding:0; border:none" width = 50%>
  <col width="22%">
  <col width="22%">
  <tr>
    ...
    <a href="https://github.com/dwulff"><b>github.com/dwulff</b></a><br><br>
    <font size=4><i>Packages</i></font><br> 
    ...
    <a href="https://cran.r-project.org/web/packages/mousetrap/index.html"><b>mousetrap</b></a>, <a href="https://github.com/dwulff/embedR"><b>embedR</b>
    </p>  
  </th>
...
<h1><a href="https://therbootcamp.github.io/DataViz_Unibas2023Nov/">Schedule</a></h1>
